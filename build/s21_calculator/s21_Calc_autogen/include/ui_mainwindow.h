...
"background-color : background-color: #FFFAFA;\n"
"border-radius: 8px;\n"
"}\n"
"\n"
...
"}"));
        ...
        pushButton_x->setGeometry(QRect(382, 322, 58, 58));
...
"background-color: white;"));
        ...
        doubleSpinBox_x->setGeometry(QRect(450, 330, 121, 41));
        QFont font4;
        font4.setPointSize(19);
        font4.setKerning(true);
        doubleSpinBox_x->setFont(font4);
        doubleSpinBox_x->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"border: 1px solid gray;\n"
"border-radius: 8px;\n"
"}"));
        ...
        doubleSpinBox_x->setValue(0.000000000000000);
...
"}"));
        ...
        result_show_2->setGeometry(QRect(380, 320, 201, 61));
