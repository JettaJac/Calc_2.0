...
void MainWindow::on_pushButton_graph_clicked()
{
    if (!(ui->pushButton_eq->isChecked())) {
        ...
        grafic->setAttribute(Qt::WA_DeleteOnClose); // для принудительного удаления виджита из памяти
        grafic->show();
   }
}
...
void MainWindow::on_pushButton_credit_clicked()
{
    ...
    credit->setAttribute(Qt::WA_DeleteOnClose); // для принудительного удаления виджита из памяти
    credit->show();
}
